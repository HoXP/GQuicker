// #define USE_MULTITHREAD_SINGLETON
...
public abstract class ASingleton<T> : ISingleton where T : ASingleton<T>
{
    ...
    private static bool isPlaying { get { return Thread.CurrentThread.ManagedThreadId == mainThreadId ? true : SingletonManager.isPlaying; } }
